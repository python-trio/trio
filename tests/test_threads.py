...
from tests._core.test_ki import ki_self
from tests._core.tutil import buggy_pypy_asyncgens
from trio import CapacityLimiter, Event, _core, sleep
from trio._core import TrioToken, current_trio_token
from trio._threads import (
...
async def test_named_thread():
    ending = " from tests.test_threads.test_named_thread"
...
async def test_named_thread_os():
    ...
    # test defaults
    default = "None from tests.test_threads.test_named_thread"
