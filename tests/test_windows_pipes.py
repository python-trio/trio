...
from trio.testing import wait_all_tasks_blocked, check_one_way_stream

if sys.platform == "win32":
    from trio._windows_pipes import PipeSendStream, PipeReceiveStream
    from trio._core._windows_cffi import _handle, kernel32
