...
from tests._core.tutil import slow, gc_collect_harder, restore_unraisablehook
from trio import _core, sleep
...
def test_lsp_that_hooks_select_gives_good_error(monkeypatch):
    from trio._core._windows_cffi import WSAIoctls, _handle
    from trio._core import _io_windows
