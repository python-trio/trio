...
# Oddly, these objects cannot interact with the IOCP APIs and therefore
# can't be merged in with the rest of the waiting in _io_windows.py.
#
...
# to 5000 events under several contrived benchmark/stress test usage patterns.
