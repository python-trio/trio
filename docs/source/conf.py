...
nitpick_ignore = [
    ...
    ("py:obj", "trio._highlevel_generic.SendStreamT"),
    ("py:obj", "trio._highlevel_generic.ReceiveStreamT"),
    ("py:class", "trio._core._thread_cache.RetT"),
    ...
    ("py:class", "trio._highlevel_generic.SendStreamT"),
    ("py:class", "trio._highlevel_generic.ReceiveStreamT"),
