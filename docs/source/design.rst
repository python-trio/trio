...
``trio.powertools``, or ``trio.testing`` namespaces. (See their
...
where cancel scopes, nurseries, and :class:`~trio.powertools.Task` are
...
public APIs are then exported as part of :mod:`trio.powertools`, and
