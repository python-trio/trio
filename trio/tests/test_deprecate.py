...
@pytest.fixture
def recwarn_always(
    recwarn: _pytest.recwarn.WarningsRecorder,
...
def test_deprecated_decorator(recwarn_always: _pytest.recwarn.WarningsRecorder) -> None:
...
def test_deprecated_alias(recwarn_always: _pytest.recwarn.WarningsRecorder) -> None:
    ...
    assert old_hotness.__doc__ is not None
