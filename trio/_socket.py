...
if TYPE_CHECKING:  # pragma: no cover
    ...
    try:
        from socket import (
            ...
            TCP_QUICKACK, TCP_SYNCNT, TCP_WINDOW_CLAMP
        )
    except ImportError:
        pass
    ...
    try:
        from socket import (
            AF_ALG, AF_CAN, AF_RDS, AF_TIPC, AF_VSOCK, ALG_OP_DECRYPT,
            ALG_OP_ENCRYPT, ALG_OP_SIGN, ALG_OP_VERIFY, ALG_SET_AEAD_ASSOCLEN,
            ...
            CAN_ERR_MASK, CAN_ISOTP, CAN_RAW, CAN_RAW_ERR_FILTER,
            CAN_RAW_FD_FRAMES, CAN_RAW_FILTER, CAN_RAW_LOOPBACK,
