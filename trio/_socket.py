...
from socket import (
    ...
    inet_pton, inet_ntop, if_nametoindex, if_indextoname, CMSG_LEN, CMSG_SPACE,
    CAPI, AF_UNSPEC, AF_INET, AF_UNIX, AF_IPX, AF_APPLETALK, AF_INET6,
    AF_ROUTE, AF_SNA, SOCK_STREAM, SOCK_DGRAM, SOCK_RAW, SOCK_SEQPACKET,
    SOCK_RDM, SO_DEBUG, SO_ACCEPTCONN, SO_REUSEADDR, SO_KEEPALIVE,
    SO_DONTROUTE, SO_BROADCAST, SO_USELOOPBACK, SO_LINGER, SO_OOBINLINE,
    SO_REUSEPORT, SO_SNDBUF, SO_RCVBUF, SO_SNDLOWAT, SO_RCVLOWAT, SO_SNDTIMEO,
    ...
    MSG_TRUNC, MSG_CTRUNC, MSG_WAITALL, MSG_EOF, SOL_SOCKET, SOL_IP, SOL_TCP,
    ...
    IPPROTO_TP, IPPROTO_ROUTING, IPPROTO_FRAGMENT, IPPROTO_RSVP, IPPROTO_GRE,
    IPPROTO_ESP, IPPROTO_AH, IPPROTO_ICMPV6, IPPROTO_NONE, IPPROTO_DSTOPTS,
    IPPROTO_XTP, IPPROTO_EON, IPPROTO_PIM, IPPROTO_IPCOMP, IPPROTO_RAW,
    ...
    EAI_NODATA, EAI_NONAME, EAI_OVERFLOW, EAI_SERVICE, EAI_SOCKTYPE,
    EAI_SYSTEM, EAI_BADHINTS, EAI_PROTOCOL, EAI_MAX, AI_PASSIVE, AI_CANONNAME,
    AI_NUMERICHOST, AI_NUMERICSERV, AI_MASK, AI_ALL, AI_V4MAPPED_CFG,
    AI_ADDRCONFIG, AI_V4MAPPED, AI_DEFAULT, NI_MAXHOST, NI_MAXSERV, NI_NOFQDN,
    NI_NUMERICHOST, NI_NAMEREQD, NI_NUMERICSERV, NI_DGRAM, SHUT_RD, SHUT_WR,
    SHUT_RDWR, EBADF, EAGAIN, EWOULDBLOCK, _LOCALHOST, _LOCALHOST_V6,
    _GLOBAL_DEFAULT_TIMEOUT
)
try:
    from socket import (
        if_nameindex, sethostname, AF_LINK, AF_SYSTEM, IPPROTO_IPV6,
        IPPROTO_SCTP, PF_SYSTEM, TCP_NOTSENT_LOWAT, TCP_KEEPINTVL, TCP_KEEPCNT,
        TCP_FASTOPEN
    )
except ImportError:
    pass
