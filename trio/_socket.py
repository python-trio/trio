...
from socket import (
    ...
    EAI_SERVICE, EAI_SOCKTYPE, EAI_SYSTEM, EAI_BADHINTS, EAI_PROTOCOL, EAI_MAX,
    AI_PASSIVE, AI_CANONNAME, AI_NUMERICHOST, AI_NUMERICSERV, AI_MASK, AI_ALL,
...
try:
    from socket import (
        IPPROTO_IPV6, IPPROTO_SCTP, TCP_NOTSENT_LOWAT, TCP_KEEPINTVL
    )
except ImportError:
    pass
