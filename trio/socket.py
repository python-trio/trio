...
try:
    ...
    from socket import (  # type: ignore
        ...
        ETHERTYPE_ARP, ETHERTYPE_IP, ETHERTYPE_IPV6, ETHERTYPE_VLAN, ETH_P_ALL,
        IP_ADD_SOURCE_MEMBERSHIP, IP_BLOCK_SOURCE, IP_DROP_SOURCE_MEMBERSHIP,
        IP_PKTINFO, IP_UNBLOCK_SOURCE, TCP_CC_INFO, TCP_FASTOPEN_CONNECT,
        TCP_FASTOPEN_KEY, TCP_FASTOPEN_NO_COOKIE, TCP_INQ, TCP_MD5SIG,
        TCP_MD5SIG_EXT, TCP_QUEUE_SEQ, TCP_REPAIR, TCP_REPAIR_OPTIONS,
        TCP_REPAIR_QUEUE, TCP_REPAIR_WINDOW, TCP_SAVED_SYN, TCP_SAVE_SYN,
        TCP_THIN_DUPACK, TCP_THIN_LINEAR_TIMEOUTS, TCP_TIMESTAMP, TCP_TX_DELAY,
        TCP_ULP, TCP_ZEROCOPY_RECEIVE,
    )
    # fmt: on
except ImportError:
    pass
