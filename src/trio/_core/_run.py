...
# sense.
@attrs.define(eq=False, unsafe_hash=False, repr=False, slots=False)
...
@final
@attrs.define(eq=False, unsafe_hash=False, repr=False)
...
@attrs.define(eq=False, unsafe_hash=False)
class GuestState:
    runner: Runner
