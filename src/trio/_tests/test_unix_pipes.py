...
def make_clogged_pipe() -> tuple[FdStream, FdStream]:
    s, r = make_pipe()
    try:
        while True:
...
async def test_pipe_fully() -> None:
    def make_pipe_async() -> tuple[FdStream, FdStream]:
        await _core.checkpoint()
        return make_pipe()

    def make_clogged_pipe_async() -> tuple[FdStream, FdStream]:
        await _core.checkpoint()
        return make_clogged_pipe()

    await check_one_way_stream(make_pipe_async, make_clogged_pipe_async)
